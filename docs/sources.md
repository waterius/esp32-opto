...
- ИК-диод головки RIXUTECH: **13,2 мА** при 3,3 В через 180 Ом (измерено
  2026-09-20, провод GPIO посажен на землю) — прямое напряжение ≈ 0,9 В
- приёмник головки: ИК-пульт через UART платы даёт **15274 байта на 115200**
  против 109 байт на 9600 за те же 30 секунд (2026-09-19) — несущую 38 кГц
  приёмник на 9600 отбраковывает по старт-биту
- связь со счётчиком НАРТИС-100.121RL после переделки передатчика получена
  2026-09-20: серийный номер, модель, версия ПО и показания прочитаны прошивкой
