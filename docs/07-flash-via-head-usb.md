...
| 3 | ножка 26 (TXD) ↔ правая площадка R2 | иначе выход моста борется с выходом ESP32 за линию ИК-диода (разрез из [02](02-rixutech-cp2102n-teardown.md)) |
...
| правая площадка **R2** | пин **5** платы | `OPTO_TX_PIN`, в ИК-диод |
...
| правая площадка **R2** | пин **18** платы | `OPTO_TX_PIN`, в ИК-диод |
...
- **[измерить]** обрыв по всем трём разрезам;
