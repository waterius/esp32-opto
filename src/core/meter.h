...
// Буфер под текст ошибки. Кириллица в UTF-8 — два байта на букву, поэтому
// «нет связи со счётчиком (адрес 16, код -1)» занимает 68 байт, а не 41: в
// прежние 64 такое сообщение не влезало и обрывалось посреди буквы.
const size_t METER_ERROR_CAP = 96;
