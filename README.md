...
Как собрать, что проверить перед пулл-реквестом и какие правила легко нарушить
не заметив — [CONTRIBUTING.md](CONTRIBUTING.md). О безопасности, включая
осознанно принятые риски, о которых сообщать не нужно — [SECURITY.md](SECURITY.md).

**Лицензия проекта пока не выбрана.** Связка зависимостей несовместима: Gurux
идёт под GPLv2 без оговорки «или новее», а ElegantOTA — под AGPLv3. Разбор и
варианты развязки — [docs/10-licenses.md](docs/10-licenses.md).
